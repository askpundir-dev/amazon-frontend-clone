...
class Product {
  ...
  // getPriceCents(value=''){
  //  return `$${formatCurrency(value!==''?value:this.priceCents)}`;
  // }
...
//IMPORTING PRODUCTS FROM BACKEND using class XMLHttpRequest();
/*
...
//IMPORTING PRODUCTS FROM BACKEND using fetch() that returns a promise
...
// });
// console.log(products); 
//now each of the value is a product class intead of regular array.
